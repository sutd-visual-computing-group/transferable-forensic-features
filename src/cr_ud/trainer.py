# The base script is borrowed from https://github.com/peterwang512/CNNDetection
...
class Trainer(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain and not opt.continue_train:
            ...
            print("Using {} with transfer learning...".format(opt.arch))
        ...
        if not self.isTrain or opt.continue_train:
            ...
            print("Using {} without transfer learning...".format(opt.arch))
